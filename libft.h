...
void    *ft_memmove(void *dest, const void *src, size_t lens);
size_t	ft_strlcpy(char *dest, const char *src, size_t lens);
size_t	ft_strlcat(char *dest, const char *src, size_t lens);
